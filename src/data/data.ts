...
export const data:dataSpec = {
    text:[
        `Embark on a scholarly exploration into the enduring challenge of Boolean Monotonicity 
        Testing, an age-old puzzle in Algorithm Design that has evoked scholarly fascination for 
        decades. The saga commenced with the pioneering contributions of Goldreich, Goldwasser, 
        Lehman, Ron, and Samordinsky, who devised algorithms operating at an admirable O(n) 
        efficiency, illuminating the path for Boolean Monotonicity Testing over the Hypercube 
        within the Property Testing Framework.`,
        ...
        results are very recent ond only appeared in FOCS 2023 and STOC 2023.`,
